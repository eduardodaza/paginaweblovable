...
const SOCIAL_LINKS = {
  instagram: "https://instagram.com/smarttravelapp",
  twitter:   "https://twitter.com/smarttravelapp",
  facebook:  "https://facebook.com/smarttravelapp",
  youtube:   "https://youtube.com/@smarttravelapp",
  email:     "mailto:hola@smarttravel.app",
  tiktok:    "https://tiktok.com/@smarttravelapp",
};
  ...
  const nav = [
    {
      ...
      links: [
        { label: es ? "Generador"    : "Generator",     href: "/#generador" },
        { label: es ? "Destinos"     : "Destinations",  href: "/#destinos"  },
        { label: "Demo",                                 href: "/#generador" },
        { label: es ? "Precios"      : "Pricing",       href: "/#precios"   },
        { label: es ? "Novedades"    : "What's new",    href: "/novedades"  },
      ],
    },
    {
      t: es ? "Recursos" : "Resources",
      links: [
        { label: es ? "Blog"         : "Blog",          href: "/#blog"      },
        { label: es ? "Guías"        : "Guides",        href: "/guias"      },
        { label: es ? "Centro ayuda" : "Help center",   href: "/ayuda"      },
        { label: es ? "Comunidad"    : "Community",     href: "/comunidad"  },
        { label: "API docs",                             href: "#"           },
      ],
    },
    {
      ...
      links: [
        { label: es ? "Sobre nosotros": "About us",     href: "/sobre-nosotros" },
        { label: es ? "Carreras"      : "Careers",      href: "#"           },
        { label: es ? "Prensa"        : "Press",        href: "#"           },
        { label: es ? "Contacto"      : "Contact",      href: "/contacto"   },
  ...
  return (
    <footer style={{ background: "hsl(230 30% 8%)", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-sm" style={{ color: "rgba(255,255,255,0.45)" }}>
              {es ? "Planifica tu viaje completo en menos de un minuto." : "Plan your full trip in under one minute."}
            </p>
          </div>
          <a href="/#generador"
            ...
            {es ? "Crear mi plan de viaje" : "Create my travel plan"} <ArrowRight style={{ width:16, height:16 }} />
          </a>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-7 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm font-medium text-white">
              {es ? "Los mejores destinos y consejos de viaje cada semana" : "Best destinations and travel tips weekly"}
            </p>
          </div>
          <div className="flex gap-2 w-full md:w-auto">
            <input type="email" placeholder={es ? "tu@correo.com" : "your@email.com"}
              className="flex-1 md:w-60 px-4 py-2.5 rounded-full text-sm outline-none"
              style={{ background:"rgba(255,255,255,0.07)", border:"1px solid rgba(255,255,255,0.12)", color:"#fff" }} />
            <button className="px-5 py-2.5 rounded-full text-sm font-semibold text-white hover:opacity-90 transition"
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid md:grid-cols-4 gap-12">
        <div>
          <a href="/" className="flex items-center gap-2.5 font-bold text-lg mb-4">
            ...
            <span className="text-white">Smart <span style={{ color:"hsl(12 85% 65%)" }}>Travel</span></span>
          </a>
          <p className="text-sm leading-relaxed max-w-xs" style={{ color:"rgba(255,255,255,0.42)" }}>
            {es ? "Planifica tu viaje completo en menos de un minuto. Gratis, simple y sin registro." : "Plan your full trip in under one minute. Free, simple and no sign-up required."}
          </p>
          <a href={SOCIAL_LINKS.email} className="mt-4 flex items-center gap-2 text-sm hover:text-white transition" style={{ color:"rgba(255,255,255,0.38)" }}>
            <Mail style={{ width:14, height:14 }} /> hola@smarttravel.app
          </a>
          <div className="mt-5 flex flex-wrap gap-2">
            {[
              ...
              <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label} title={label}
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.color="#fff"; (e.currentTarget as HTMLAnchorElement).style.background="rgba(255,255,255,0.14)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.color="rgba(255,255,255,0.5)"; (e.currentTarget as HTMLAnchorElement).style.background="rgba(255,255,255,0.07)"; }}>
                <Icon />
              </a>
            ))}
          </div>
      ...
      <div className="px-6 py-5" style={{ borderTop:"1px solid rgba(255,255,255,0.06)" }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-xs" style={{ color:"rgba(255,255,255,0.3)" }}>
          <span>© {new Date().getFullYear()} Smart Travel. {es ? "Todos los derechos reservados." : "All rights reserved."}</span>
